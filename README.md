...
**TODO** if there's 20 agents, say so

### Solving the Environment

**TODO** choose from the below
...
5. Download the environment from one of the links below.  You need only select the environment that matches your operating system:
    **TODO** choose the number of agents
...
**TODO** double check that the below is correct (particularly the organization e.g. src folder etc)
...
**TODO** double check this part; make sure the sections are right.
